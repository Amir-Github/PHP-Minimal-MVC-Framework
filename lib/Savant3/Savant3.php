...
class Savant3 {
	...
	*/
	...
	protected function findFile($type, $file , $path = null)
	{
	...
	*/
	...
	public function display($tpl , $path = null)
	{
		echo $this->getOutput($tpl , $path = null);
	}
	 ...
	 * @return string The template output.
	 */
	public function getOutput($tpl , $path = null)
	{
	    $output = $this->fetch($tpl , $path);
	...
	*/
	...
	public function fetch($tpl , $path = null)
	{
	...
	*/
	...
	protected function template($tpl , $path = null)
	{
		...
		$file = $this->findFile('template', $tpl , $path);
		if (! $file) {
			return $this->error(
				'ERR_TEMPLATE',
				array('template' => $tpl)
